...
<div style="text-align: center; margin-top: 30px; margin-bottom: 40px;">
  <img src="{{ '/assets/images/profile.png' | relative_url }}" alt="Manjunath Prasad H. R." style="width: 180px; border-radius: 50%; box-shadow: 0 0 10px rgba(0,0,0,0.15); margin-bottom: 15px;">
  <h1 style="margin-bottom: 5px;">Manjunath Prasad H. R.</h1>
  <h4 style="color: #444; margin-top: 0;">Assistant Professor </h4>
  <h4 style="color: #444; margin-top: 0;">Department of Computer Applications</h4>
  <h4 style="color: #555;">Nitte Institute of Professional Education, Nitte (Deemed to be University), India</h4>

  <div style="margin-top: 15px;">
    <a href="{{ '/group/' | relative_url }}" style="text-decoration:none; background:#0056b3; color:white; padding:8px 15px; border-radius:5px; margin-right:8px;">Research Group</a>
    <a href="{{ '/publications/' | relative_url }}" style="text-decoration:none; background:#6c3483; color:white; padding:8px 15px; border-radius:5px; margin-right:8px;">Publications</a>
    <a href="https://scholar.google.com/citations?user=5370e0oAAAAJ&hl=en" style="text-decoration:none; background:#333; color:white; padding:8px 15px; border-radius:5px;">Google Scholar</a>
  </div>
</div>
...
<!-- ===== Two-Column Layout ===== -->
<!-- ===== Two-Column Layout (Broadened Width) ===== -->
<div style="display: flex; flex-wrap: wrap; gap: 40px; max-width: 1100px; margin: 0 auto;">


  <!-- Left Sidebar -->
  <div style="flex: 1; min-width: 240px; max-width: 280px; background: #f8f9fa; padding: 15px 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.05); height: fit-content;">
    <h3>Contact</h3>
    <p style="font-size: 0.95em;">
      Nitte Institute of Professional Education<br>
      Nitte (Deemed to be University), India<br>
      <a href="mailto:manjunathprasad.github.io">Email</a><br>
  ...
  <div style="flex: 3.5; min-width: 350px;">
    ...
    <h2>Academic Role</h2>
    <p>
      I teach courses on <strong>Programming languages</strong> (Python and C#) and <strong>Multi-cloud Courses</strong>. 
